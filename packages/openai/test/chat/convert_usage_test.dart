...
void main() {
  group('convertOpenAiChatUsage', () {
    test('usage 为 null 时返回全 null 壳', () {
      final usage = convertOpenAiChatUsage(null);
    ...
    test('完整 usage 对象按两级判空精确复刻', () {
      ...
      final usage = convertOpenAiChatUsage(rawUsage);
    ...
    test('usage 存在但缺少 details 字段时按 0 兜底(非全 null)', () {
      final usage = convertOpenAiChatUsage(<String, Object?>{
        'prompt_tokens': 10,
        'completion_tokens': 5,
      });
