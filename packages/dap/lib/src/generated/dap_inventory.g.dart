...
const dapGeneratedSpecificationVersion = '1.71.0';
const dapGeneratedSourceRelease = 'v1.71.0';
const dapGeneratedSourceRevision = '51d95ea4e692b34c5d06601bbd1bebc1ff3fbdd4';
const dapGeneratedSchemaSha256 =
    'ff8ae4c6cfd588a050e9346c35fd104748a27ef4518d1c3268529ca6f8ff5818';
const dapGeneratedSchemaDialect = 'http://json-schema.org/draft-04/schema#';
const dapGeneratedClosedEnumCount = 83;
const dapGeneratedOpenEnumCount = 14;

const dapGeneratedSchemaJson = r'''{
...
const dapGeneratedDefinitionClassifications = <String, String>{
  ...
  'Event': 'envelope',
  'ExceptionBreakMode': 'type',
  'ExceptionBreakpointsFilter': 'type',
  'ExceptionDetails': 'type',
  'ExceptionFilterOptions': 'type',
  'ExceptionInfoArguments': 'arguments',
  'ExceptionInfoRequest': 'request',
  'ExceptionInfoResponse': 'response',
  'ExceptionOptions': 'type',
  'ExceptionPathSegment': 'type',
  'ExitedEvent': 'event',
  'FunctionBreakpoint': 'type',
  ...
  'InstructionBreakpoint': 'type',
  'InvalidatedAreas': 'type',
  'InvalidatedEvent': 'event',
  'LaunchRequest': 'request',
  'LaunchRequestArguments': 'arguments',
  'LaunchResponse': 'response',
  'LoadedSourceEvent': 'event',
  'LoadedSourcesArguments': 'arguments',
  'LoadedSourcesRequest': 'request',
  'LoadedSourcesResponse': 'response',
  ...
  'RestartFrameRequest': 'request',
  'RestartFrameResponse': 'response',
  'RestartRequest': 'request',
  'RestartResponse': 'response',
  'ReverseContinueArguments': 'arguments',
  'ReverseContinueRequest': 'request',
  'ReverseContinueResponse': 'response',
  'RunInTerminalRequest': 'request',
  'RunInTerminalRequestArguments': 'arguments',
  'RunInTerminalResponse': 'response',
  'Scope': 'type',
  ...
  'SetDataBreakpointsRequest': 'request',
  'SetDataBreakpointsResponse': 'response',
  ...
  'SetExpressionResponse': 'response',
  ...
  'SourceBreakpoint': 'type',
  'SourceRequest': 'request',
  'SourceResponse': 'response',
  'StackFrame': 'type',
  'StackFrameFormat': 'type',
  ...
  'StartDebuggingResponse': 'response',
  'StepBackArguments': 'arguments',
  'StepBackRequest': 'request',
  'StepBackResponse': 'response',
  ...
  'StepInTargetsResponse': 'response',
  'StepOutArguments': 'arguments',
  'StepOutRequest': 'request',
  'StepOutResponse': 'response',
  'SteppingGranularity': 'type',
  'StoppedEvent': 'event',
  'TerminateArguments': 'arguments',
  'TerminateRequest': 'request',
  'TerminateResponse': 'response',
  'TerminateThreadsArguments': 'arguments',
  'TerminateThreadsRequest': 'request',
  'TerminateThreadsResponse': 'response',
...
const dapGeneratedRequestMetadata = <Map<String, String?>>[
  ...
  <String, String?>{
    ...
    'request': 'BreakpointLocationsRequest',
    'response': 'BreakpointLocationsResponse',
  ...
  <String, String?>{
    ...
    'response': 'SetFunctionBreakpointsResponse',
    'arguments': 'SetFunctionBreakpointsArguments',
  },
  <String, String?>{
    'command': 'setExceptionBreakpoints',
    'request': 'SetExceptionBreakpointsRequest',
    'response': 'SetExceptionBreakpointsResponse',
    'arguments': 'SetExceptionBreakpointsArguments',
  },
  <String, String?>{
    'command': 'dataBreakpointInfo',
    'request': 'DataBreakpointInfoRequest',
    'response': 'DataBreakpointInfoResponse',
    'arguments': 'DataBreakpointInfoArguments',
  },
  <String, String?>{
    'command': 'setDataBreakpoints',
    'request': 'SetDataBreakpointsRequest',
    'response': 'SetDataBreakpointsResponse',
    'arguments': 'SetDataBreakpointsArguments',
  },
  <String, String?>{
    'command': 'setInstructionBreakpoints',
    'request': 'SetInstructionBreakpointsRequest',
    'response': 'SetInstructionBreakpointsResponse',
  ...
  <String, String?>{
    ...
    'response': 'StepInResponse',
    'arguments': 'StepInArguments',
  },
  <String, String?>{
    'command': 'stepOut',
    'request': 'StepOutRequest',
    'response': 'StepOutResponse',
  ...
  <String, String?>{
    ...
    'request': 'ReverseContinueRequest',
    'response': 'ReverseContinueResponse',
    'arguments': 'ReverseContinueArguments',
  },
  <String, String?>{
    'command': 'restartFrame',
    'request': 'RestartFrameRequest',
    'response': 'RestartFrameResponse',
  ...
  <String, String?>{
    ...
    'request': 'TerminateThreadsRequest',
    'response': 'TerminateThreadsResponse',
  ...
  <String, String?>{
    ...
    'request': 'LoadedSourcesRequest',
    'response': 'LoadedSourcesResponse',
  ...
  <String, String?>{
    ...
    'request': 'StepInTargetsRequest',
    'response': 'StepInTargetsResponse',
    'arguments': 'StepInTargetsArguments',
  },
  <String, String?>{
    'command': 'gotoTargets',
    'request': 'GotoTargetsRequest',
    'response': 'GotoTargetsResponse',
  ...
  <String, String?>{
    ...
    'response': 'ExceptionInfoResponse',
...
const dapGeneratedEventMetadata = <Map<String, String>>[
  <String, String>{
    'event': 'initialized',
    'definition': 'InitializedEvent',
  },
  <String, String>{
    'event': 'stopped',
    'definition': 'StoppedEvent',
  },
  <String, String>{
    'event': 'continued',
    'definition': 'ContinuedEvent',
  },
  <String, String>{
    'event': 'exited',
    'definition': 'ExitedEvent',
  },
  <String, String>{
    'event': 'terminated',
    'definition': 'TerminatedEvent',
  },
  <String, String>{
    'event': 'thread',
    'definition': 'ThreadEvent',
  },
  <String, String>{
    'event': 'output',
    'definition': 'OutputEvent',
  },
  <String, String>{
    'event': 'breakpoint',
    'definition': 'BreakpointEvent',
  },
  <String, String>{
    'event': 'module',
    'definition': 'ModuleEvent',
  },
  <String, String>{
    'event': 'loadedSource',
    'definition': 'LoadedSourceEvent',
  },
  <String, String>{
    'event': 'process',
  ...
  <String, String>{
    'event': 'capabilities',
    'definition': 'CapabilitiesEvent',
  },
  <String, String>{
    'event': 'progressStart',
    'definition': 'ProgressStartEvent',
  },
  <String, String>{
    'event': 'progressUpdate',
    'definition': 'ProgressUpdateEvent',
  },
  <String, String>{
    'event': 'progressEnd',
    'definition': 'ProgressEndEvent',
  },
  <String, String>{
    'event': 'invalidated',
    'definition': 'InvalidatedEvent',
  },
  <String, String>{
    'event': 'memory',
    'definition': 'MemoryEvent',
  },
];
